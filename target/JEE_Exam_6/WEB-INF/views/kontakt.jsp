...
<div class="probaHome1">
    ...
    <div class="probaHome3">
        ...
        <span class="solidBlackBottom"> Kontakt z nami:  </span><br/>
        <input name="Imię" type="text" placeholder="Twoje imię"/> <br/>
        <input name="Email" type="email" placeholder="Twój email"/><br/>
        <input name="Temat" type="text" placeholder="Temat"/><br/>
        <textarea name="Komentarz" cols="50" rows="10">Wpisz swój komentarz tutaj</textarea> <br/>

        <a href="<c:url value="/kontakt"/>">

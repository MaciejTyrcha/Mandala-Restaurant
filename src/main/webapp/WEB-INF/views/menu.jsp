...
<div class="probaHome1">
    ...
    <div class="probaHome3">
        ...
        <span class="solidBlackBottom"> Dania:  </span>
        <table id="foods">
            <thead>
            <tr>
                <th>Nazwa dania</th>
            ...
            <c:forEach var="food" items="${allfoods}">
                <tr>
                    ...
                    <td>
                        <a href="/menu/${food.id}/delete">Usuń</a>
                        <a href="/menu/${food.id}/edit">Edytuj</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
        <a href="<c:url value="/menu/add"/>">
            <input type="submit" class="button" value="Dodaj danie"/>
        </a>
    </div>
    <div class="probaHome2">
